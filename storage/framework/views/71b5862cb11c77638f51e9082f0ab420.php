                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('admin.pengguna.destroy', $pengguna->id)); ?>" method="POST">
                                    <a href="<?php echo e(route('admin.pengguna.show', $pengguna->id)); ?>" class="btn btn-sm btn-primary">SHOW</a>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\DewiAmelia_Uts_SewaKendaraan\resources\views/levelAdmin/user/index.blade.php ENDPATH**/ ?>